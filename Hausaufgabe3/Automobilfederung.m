%% Automobilfederung: 
% contains class Automobilfederung to calculate and visualize a
% spring-damper-system in the automotive context
%
% Author: Jannik Wiessler & Adrian Waldera
% DHBW Stuttgart
% email: jannik.wiessler@daimler.com & adrianwaldera@gmx.de
% data: Q2 2022
    ...
    methods (Access = public)
        ...
        function sim(obj, varargin)
            ...
            while (t < tfinal)
                ...
                % ========= YOUR CODE HERE =========
                k1 = rhs(obj, t, y);
                k2 = rhs(obj, t + h/2, y + h/2*k1);
                k3 = rhs(obj, t + h/2, y + h/2*k2);
